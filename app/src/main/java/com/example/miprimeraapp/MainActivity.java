...
public class MainActivity extends AppCompatActivity {
    ...
    Double valores[][] = {
            ...
            {1.0, 1000.0, 0.001, 0.264172, 1.05669, 0.0353147}, //volumen
            {1.0, 1000.0, 0.001, 2.20462, 35.274}, //masa
            {1.0, 0.000000001, 0.000001, 0.001, 1000.0} //almacenamiento
    };
    String[][] etiquetas = {
            {"Dolar", "Euro", "Quetzal", "Lempira", "Cordoba", "Colon CR"}, //monedas
            {"Mts", "Ml", "Cm", "Pulgada", "Pies", "Vara", "Yarda"}, //Longitud
            {"L", "Ml", "m³", "gal", "qt", "ft"},  //volumen
            {"Kg", "G", "T", "Lb", "Oz"}, //masa
            {"GB", "B", "KB", "MB", "TB"} //almacenamiento
    };

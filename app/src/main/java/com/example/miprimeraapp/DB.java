...
public class DB extends SQLiteOpenHelper {
    ...
    private static final String SQLdb = "CREATE TABLE amigos (idAmigo INTEGER PRIMARY KEY AUTOINCREMENT, nombre TEXT, direccion TEXT, " +
            "telefono TEXT, email TEXT, dui TEXT, urlFoto TEXT)";
    ...
    public void onUpgrade(SQLiteDatabase sqLiteDatabase, int i, int i1) {
        //actualizar la definicion de la BD
        ...
        try {
            ...
            switch (accion){
                case "nuevo":
                    ...
                    break;
                case "modificar":
                    sql = "UPDATE amigos SET nombre = '"+datos[1]+"', direccion = '"+datos[2]+"', telefono = '"+datos[3]+"', email = '"+datos[4]+"', dui = '"+datos[5]+"', urlFoto = '"+datos[6]+"'";
                    break;
                case "eliminar":
